...
os.system(mkdir)
mkdir = 'mkdir distancias/{0}/img'.format(INPUT)
os.system(mkdir)
...
plt.ylim(0, 0.5)
plt.savefig(out_dir + '/img/cmm_dist.png')
plt.clf()
...
plt.xlim(0.5, len(cmm) + 0.5)
plt.ylim(0, 0.5)
plt.savefig(out_dir + '/img/wp_dist.png')
plt.clf()
...
plt.xlim(0.5, len(cmm) + 0.5)
plt.ylim(0, 0.5)
plt.savefig(out_dir + '/img/ahp_dist.png')
plt.clf()
...
plt.xlim(0.5, len(cmm) + 0.5)
plt.ylim(0, 0.5)
plt.savefig(out_dir + '/img/odi_dist.png')
plt.clf()
